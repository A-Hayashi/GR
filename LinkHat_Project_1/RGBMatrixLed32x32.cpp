...
void RGBMatrixLed32x32::_update(void)
{
    ...
    for (x = 0; x<32; x++)
    {
        digitalWrite(_pinR0, ((_dispRam[line   ][x].R>pos)? HIGH: LOW));
        digitalWrite(_pinR1, ((_dispRam[line+16][x].R>pos)? HIGH: LOW));
        digitalWrite(_pinG0, ((_dispRam[line   ][x].G>pos)? HIGH: LOW));
        digitalWrite(_pinG1, ((_dispRam[line+16][x].G>pos)? HIGH: LOW));
        digitalWrite(_pinB0, ((_dispRam[line   ][x].B>pos)? HIGH: LOW));
        digitalWrite(_pinB1, ((_dispRam[line+16][x].B>pos)? HIGH: LOW));
